...
layout = html.Div([
    html.H1('TBIC Shares by Currency', style={'textAlign': 'center'}),
    dbc.Row([
        dbc.Col(
            dcc.Slider(min=1, max=6, marks=slider_dict, id="ccy-treemap-slider", value=1),
...
def currency_treemap(value):
    ...
    fig = px.treemap(tbic_port, path=['portfolio', 'CCY', 'Sector', 'Industry', 'Company Name'],
